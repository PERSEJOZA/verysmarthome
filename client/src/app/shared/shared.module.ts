...
import {
    httpRequestErrorHandlerProvider
} from '../services/interceptors/http-request-error-handler.provider';
...
@NgModule({
  ...
  exports: [
    CommonModule, ReactiveFormsModule, HttpClientModule, HeaderComponent, SpinnerComponent
  ]
})
